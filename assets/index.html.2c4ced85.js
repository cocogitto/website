...
Changes to be committed:
  (use <span class="hljs-string">&quot;git restore --staged &lt;file&gt;...&quot;</span> to unstage)
	new file:   cog.toml
</code></pre></div><h2 id="conventional-commits" tabindex="-1"><a class="header-anchor" href="#conventional-commits" aria-hidden="true">#</a> Conventional commits</h2>`,12),m=s("code",null,"cog commit",-1),g=e(" allows you to easily create commits respecting the "),b={href:"https://www.conventionalcommits.org/en/v1.0.0/",target:"_blank",rel:"noopener noreferrer"},f=e("conventional commits specification"),_=e(". It comes with a set of predefined arguments named after conventional commit types and "),j={href:"https://github.com/angular/angular/blob/22b96b9/CONTRIBUTING.md#-commit-message-guidelines",target:"_blank",rel:"noopener noreferrer"},v=e("Angular commit convention"),y=a(" : (<code>feat</code>, <code>fix</code>, <code>style</code>, <code>build</code>, <code>refactor</code>, <code>ci</code>, <code>test</code>, <code>perf</code>, <code>chore</code>, <code>revert</code>, <code>docs</code>).",23),k=a(`<p>As described in the specification conventional commits messages are structured as follows :</p><div class="language-conventional ext-conventional"><pre class="language-conventional"><code><span class="hljs-string">&lt;type&gt;</span>[<span class="hljs-literal">optional</span> scope]: <span class="hljs-string">&lt;description&gt;</span>
...
</code></pre></div>`,14),w=e("This would create the following "),x={href:"https://www.conventionalcommits.org/en/v1.0.0/#commit-message-with--to-draw-attention-to-breaking-change",target:"_blank",rel:"noopener noreferrer"},q=e("breaking change"),A=e(" commit : "),E=s("code",null,"fix(cli)!: fix a nasty bug",-1),T=e("."),D=s("code",null,"cog commit",-1),P=e(" use the "),C=s("code",null,"!",-1),I=e(" notation to denote breaking changes commit because it can be easily seen in your git log, however if you manually create breaking changes commits with "),H={href:"https://www.conventionalcommits.org/en/v1.0.0/#commit-message-with-description-and-breaking-change-footer",target:"_blank",rel:"noopener noreferrer"},F=e("the footer notation"),S=e(" cocogitto tools will still pick them."),N=a(`<h3 id="commit-body-and-footers" tabindex="-1"><a class="header-anchor" href="#commit-body-and-footers" aria-hidden="true">#</a> Commit Body and footers</h3><p>If you need to create more complex commit messages with body and footers use the <code>--edit</code> flag.</p><p><strong>Example:</strong></p><div class="language-bash ext-sh"><pre class="language-bash"><code><span class="hljs-built_in">cog</span> commit refactor -e -B <span class="hljs-string">&quot;drop support for Node 6&quot;</span> runtime 
...
</code></pre></div><h2 id="tag-prefix" tabindex="-1"><a class="header-anchor" href="#tag-prefix" aria-hidden="true">#</a> Tag prefix</h2>`,40),fs=e("It is common to use a tag prefix when creating version in your repository. This is described in the "),_s={href:"https://semver.org/#is-v123-a-semantic-version",target:"_blank",rel:"noopener noreferrer"},js=e("SemVer specification FAQ"),vs=e(". This convention provide a handy way to distinguish between release versions and tags that does not represent releases."),ys=s("p",null,[e("To tell "),s("code",null,"cog"),e(" to pick only version starting with a prefix set this in your "),s("code",null,"cog.toml"),e(" file :")],-1),ks=s("div",{class:"language-toml ext-toml"},[s("pre",{class:"language-toml"},[s("code",null,[s("span",{class:"hljs-attr"},"tag_prefix"),e(" = "),s("span",{class:"hljs-string"},'"v"'),e(`
`)])])],-1);function ws(t,xs){const n=l("ExternalLinkIcon");return i(),c(p,null,[u,s("p",null,[m,g,s("a",b,[f,o(n)]),_,s("a",j,[v,o(n)]),y]),k,s("p",null,[w,s("a",x,[q,o(n)]),A,E,T]),s("p",null,[D,P,C,I,s("a",H,[F,o(n)]),S]),N,s("p",null,[O,z,R,s("a",B,[G,o(n)]),Y]),M,s("p",null,[s("a",W,[L,o(n)])]),V,s("img",{src:t.$withBase("github-release-changelog.png"),alt:"Github release changelog screenshot"},null,8,$),J,s("p",null,[U,s("a",K,[Q,o(n)]),X]),Z,s("div",ss,[es,as,s("ul",null,[ns,s("li",null,[os,ts,s("a",ls,[is,o(n)]),cs])]),rs]),ps,s("div",hs,[ds,s("p",null,[us,s("code",null,"cog_bump_"+r(t.version),1),ms]),gs]),bs,s("p",null,[fs,s("a",_s,[js,o(n)]),vs]),ys,ks],64)}var Es=h(d,[["render",ws]]);export{Es as default};
